...
def main():
    ...
    dummy_postcode = "SW1A 1AA"  # Westminster, London
    dummy_radius = 1
    dummy_days = 90
    
    print("UK Planning Applications - Dummy Example")
    print("=" * 50)
    print(f"Searching for planning applications within {dummy_radius}km of {dummy_postcode}...")
    
    # Search for applications
    applications = search_planning_applications_by_postcode(dummy_postcode, dummy_radius, dummy_days)
